...
## Report bugs using Github's [issues](https://github.com/sopherapps/go-scdb/issues)

We use GitHub issues to track public bugs. Report a bug
by [opening a new issue](https://github.com/sopherapps/go-scdb/issues); it's that easy!
